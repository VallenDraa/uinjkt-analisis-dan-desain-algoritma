...
public class App {
  public static void main(String[] args) {
    ...
    WriteToFile.writeNumberArray(unsortedArray, "src/sorting_algorithms/radix_sort/unsorted.txt");

    // Sort array dan ukur waktu yang dibutuhkan
    long startTime = System.currentTimeMillis();
    Integer[] sortedArray = RadixSort.sort(unsortedArray);
    ...
    WriteToFile.writeNumberArray(sortedArray, "src/sorting_algorithms/radix_sort/sorted.txt");
