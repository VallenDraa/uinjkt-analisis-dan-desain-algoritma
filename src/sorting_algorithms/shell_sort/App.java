package sorting_algorithms.shell_sort;
...
public class App {
  public static void main(String[] args) {
    ...
    WriteToFile.writeNumberArray(unsortedArray, "src/sorting_algorithms/shell_sort/unsorted.txt");

    // Sort array dan ukur waktu yang dibutuhkan
    long startTime = System.currentTimeMillis();
    Integer[] sortedArray = ShellSort.sort(unsortedArray);
    ...
    WriteToFile.writeNumberArray(sortedArray, "src/sorting_algorithms/shell_sort/sorted.txt");
