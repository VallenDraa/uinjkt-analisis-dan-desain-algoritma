...
public class App {
  public static void main(String[] args) {
    ...
    WriteToFile.writeNumberArray(array, "src/sorting_algorithms/merge_sort/unsorted.txt");
    ...
    WriteToFile.writeNumberArray(array, "src/sorting_algorithms/merge_sort/sorted.txt");
