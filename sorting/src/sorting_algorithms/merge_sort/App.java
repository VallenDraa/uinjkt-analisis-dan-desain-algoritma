...
public class App {
  public static void main(String[] args) {
    ...
    WriteToFile.writeNumberArray(unsortedArray, "src/sorting_algorithms/merge_sort/unsorted.txt");
    ...
    WriteToFile.writeNumberArray(unsortedArray, "src/sorting_algorithms/merge_sort/sorted.txt");
